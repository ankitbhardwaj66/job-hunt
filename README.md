...
6. **Activity check** — checks the Activity section on the same profile page (no extra navigation). Must have posted at least once in the last **6 months**.
...
| has_recent_activity | True if posted in last 6 months |
| recent_activity_30d | 1 if active, 0 if not |
